...
function UserList() {
  ...
  const columns = useMemo( ()=> [
    ...
    { title: "Phone Number", field: "phone", align: "center", grouping: false },
    {
      ...
      render: (rowData) => <div style={{ background: rowData.age >= 18 ? "#008000aa" : "#f90000aa",borderRadius:"4px",paddingLeft:5 }}>{rowData.age >= 18 ? "18+" : "18-"}</div>,searchable: false, export: false
    },
  ...
  return (
    <>
   <Sidebar />
      <h1 align="center">UserList Update</h1>
